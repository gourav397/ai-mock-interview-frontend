...
const FALLBACK_CATEGORIES = [
  ...
  "General Hindi", "General Science", "Mathematics"
];
...
function Interview() {
  ...
  const skipQuestion = () => {
    setAnswers((prev) => {
      const next = { ...prev };
      delete next[current]; // skip → answer hatao → pakka galat count
      return next;
    });
    goNext();
  };
  ...
  // filter ke hisaab se question indexes
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <button
                onClick={() => {
                  ...
                  setAnswers({}); setCurrent(0); setTimeLeft(30); setCategory("");
                }}
